...
<body class="d-flex flex-column h-100">
	...
	<div class="modal fade" id="confirmOperationModal" tabindex="-1"  aria-labelledby="confirmOperationModalLabel"
	    ...
	    <div class="modal-dialog" >
	        <div class="modal-content">
	            ...
	            <form method="post" action="${pageContext.request.contextPath}/annuncio/cambiaStato" >
		            <div class="modal-footer">
		            	<input type="hidden" name="idAnnuncioForChangingStato" id="idAnnuncioForChangingStato">
	...
	<script type="text/javascript">
		...
		$(".link-for-modal").click(function(){
			...
			$('#idAnnuncioForChangingStato').val(callerId);
		});
	</script>
