			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="insert_annuncio_attr" method="post" action="/annuncio/save/${userInfo.id}" novalidate="novalidate" class="row g-3">
					
							
								<div class="col-md-6">
									<label for="testoAnnuncio" class="form-label">Testo annuncio <span class="text-danger">*</span></label>
									<spring:bind path="testoAnnuncio">
										<input type="text" name="testoAnnuncio" id="testoAnnuncio" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il testoAnnuncio" value="${insert_annuncio_attr.testoAnnuncio }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="prezzo">
										<input type="number" min="1" name="prezzo" id="prezzo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il prezzo" value="${insert_annuncio_attr.prezzo }" required>
									</spring:bind>
									<form:errors  path="prezzo" cssClass="error_field" />
								</div>
								
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${insert_annuncio_attr.data }'/>
								<div class="col-md-3">
